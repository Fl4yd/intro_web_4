...
var text = document.getElementById('input-show');
...
function _getMovies() {
  _getMovies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(movieName) {
    var url, usersPromise, userJSON;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "https://api.tvmaze.com/search/shows?q=" + movieName;
          _context.next = 3;
          return fetch(url);
        case 3:
          usersPromise = _context.sent;
          _context.next = 6;
          return usersPromise.json();
        case 6:
          userJSON = _context.sent;
          console.log(userJSON);
          userJSON.forEach(function (movie) {
            var newMovie = document.createElement('div');
            var image = document.createElement('img');
            var show_info = document.createElement('div');
            var title = document.createElement('h1');
            var summary = movie.show.summary;
